...
bag = rosbag('original_ov_indoor_forward_5_dragon_pathimu.bag');
...
outdoor5_ours = [t_s,t_Ns,x,y,z,qx,qy,qz,qw];



save('original_ov_indoor_forward_5_dragon_pathimu.mat','outdoor5_ours')
